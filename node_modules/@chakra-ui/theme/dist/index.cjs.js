...
var baseStyle8 = (0, import_styled_system8.defineStyle)({
  w: [$size2.reference],
  h: [$size2.reference],
  borderRadius: "md",
  transitionProperty: "common",
...
var $bg5 = (0, import_styled_system12.cssVar)("drawer-bg");
var $bs = (0, import_styled_system12.cssVar)("drawer-box-shadow");
...
var $fg3 = (0, import_styled_system14.cssVar)("form-control-color");
var baseStyleRequiredIndicator = (0, import_styled_system14.defineStyle)({
  marginStart: "1",
...
var baseStyleHelperText = (0, import_styled_system14.defineStyle)({
  mt: "2",
...
var $fg4 = (0, import_styled_system15.cssVar)("form-error-color");
var baseStyleText = (0, import_styled_system15.defineStyle)({
...
var baseStyleIcon3 = (0, import_styled_system15.defineStyle)({
  marginEnd: "0.5em",
  [$fg4.variable]: `colors.red.500`,
  _dark: {
    [$fg4.variable]: `colors.red.300`
...
var baseStyle19 = (0, import_styled_system19.defineStyle)((props) => {
  return {
    bg: (0, import_theme_tools8.mode)("gray.100", "whiteAlpha")(props),
    borderRadius: "md",
    borderWidth: "1px",
...
var baseStyleList = (0, import_styled_system22.defineStyle)((props) => {
  return {
    bg: (0, import_theme_tools9.mode)("#fff", "gray.700")(props),
    boxShadow: (0, import_theme_tools9.mode)("sm", "dark-lg")(props),
    color: "inherit",
    minW: "3xs",
    py: "2",
    zIndex: 1,
...
var baseStyleItem = (0, import_styled_system22.defineStyle)((props) => {
  return {
    ...
    _focus: {
      bg: (0, import_theme_tools9.mode)("gray.100", "whiteAlpha.100")(props)
    },
    _active: {
      bg: (0, import_theme_tools9.mode)("gray.200", "whiteAlpha.200")(props)
    },
    _expanded: {
      bg: (0, import_theme_tools9.mode)("gray.100", "whiteAlpha.100")(props)
    },
...
var baseStyleDialog2 = (0, import_styled_system23.defineStyle)((props) => {
  ...
  return {
    borderRadius: "md",
    bg: (0, import_theme_tools10.mode)("white", "gray.700")(props),
    color: "inherit",
    my: "16",
    zIndex: "modal",
    maxH: scrollBehavior === "inside" ? "calc(100% - 7.5rem)" : void 0,
    boxShadow: (0, import_theme_tools10.mode)("lg", "dark-lg")(props)
  };
});
...
var $stepperWidth = (0, import_theme_tools11.cssVar)("number-input-stepper-width");
var $inputPadding = (0, import_theme_tools11.cssVar)("number-input-input-padding");
var inputPaddingValue = (0, import_theme_tools11.calc)($stepperWidth).add("0.5rem").toString();
...
var baseStyleStepper = (0, import_styled_system24.defineStyle)((props) => {
  return {
    ...
    borderStartColor: (0, import_theme_tools11.mode)("inherit", "whiteAlpha.300")(props),
    color: (0, import_theme_tools11.mode)("inherit", "whiteAlpha.800")(props),
    _active: {
      bg: (0, import_theme_tools11.mode)("gray.200", "whiteAlpha.300")(props)
    },
    _disabled: {
      opacity: 0.4,
      cursor: "not-allowed"
...
function getSize4(size2) {
  ...
  return definePartsStyle14({
    ...
    stepper: {
      fontSize: (0, import_theme_tools11.calc)(fontSize).multiply(0.75).toString(),
      _first: {
...
var $popperBg = (0, import_theme_tools12.cssVar)("popper-bg");
var $arrowBg = (0, import_theme_tools12.cssVar)("popper-arrow-bg");
var $arrowShadowColor = (0, import_theme_tools12.cssVar)("popper-arrow-shadow-color");
var baseStylePopper = (0, import_styled_system26.defineStyle)({ zIndex: 10 });
var baseStyleContent = (0, import_styled_system26.defineStyle)({
...
var filledStyle = (0, import_styled_system27.defineStyle)((props) => {
  ...
  const stripeStyle = (0, import_theme_tools13.mode)((0, import_theme_tools13.generateStripe)(), (0, import_theme_tools13.generateStripe)("1rem", "rgba(0,0,0,0.1)"))(props);
  const bgColor = (0, import_theme_tools13.mode)(`${c}.500`, `${c}.200`)(props);
  const gradient = `linear-gradient(
    to right,
    transparent 0%,
    ${(0, import_theme_tools13.getColor)(t, bgColor)} 50%,
    transparent 100%
  )`;
...
var baseStyleTrack = (0, import_styled_system27.defineStyle)((props) => {
  return {
    bg: (0, import_theme_tools13.mode)("gray.100", "whiteAlpha.300")(props)
  };
});
...
var baseStyleField2 = (0, import_styled_system29.defineStyle)((props) => {
  ...
  return {
    ...
    bg: (0, import_theme_tools14.mode)("white", "gray.700")(props),
    appearance: "none",
    paddingBottom: "1px",
    lineHeight: "normal",
    "> option, > optgroup": {
...
var baseStyle30 = (0, import_styled_system30.defineStyle)((props) => {
  const defaultStartColor = (0, import_theme_tools15.mode)("gray.100", "gray.800")(props);
  const defaultEndColor = (0, import_theme_tools15.mode)("gray.400", "gray.600")(props);
  const {
    startColor = defaultStartColor,
    endColor = defaultEndColor,
    theme: theme2
  } = props;
  const start = (0, import_theme_tools15.getColor)(theme2, startColor);
  const end = (0, import_theme_tools15.getColor)(theme2, endColor);
  return {
...
var $bg6 = (0, import_styled_system31.cssVar)("skip-link-bg");
...
var $bg7 = (0, import_styled_system32.cssVar)("slider-bg");
...
var baseStyleTrack2 = (0, import_styled_system32.defineStyle)((props) => {
  const orientationStyles = (0, import_theme_tools16.orient)({
...
var baseStyleThumb = (0, import_styled_system32.defineStyle)((props) => {
  const { orientation } = props;
  const orientationStyle = (0, import_theme_tools16.orient)({
    orientation,
    vertical: {
      left: "50%",
...
var $size3 = (0, import_theme_tools17.cssVar)("spinner-size");
...
var $width = (0, import_theme_tools18.cssVar)("switch-track-width");
var $height = (0, import_theme_tools18.cssVar)("switch-track-height");
var $diff = (0, import_theme_tools18.cssVar)("switch-track-diff");
var diffValue = import_theme_tools18.calc.subtract($width, $height);
var $translateX = (0, import_theme_tools18.cssVar)("switch-thumb-x");
var $bg8 = (0, import_theme_tools18.cssVar)("switch-bg");
...
var baseStyle35 = definePartsStyle21((props) => ({
  container: {
    ...
    _rtl: {
      [$translateX.variable]: (0, import_theme_tools18.calc)($diff).negate().toString()
    }
  },
...
var variantSimple = definePartsStyle22((props) => {
  ...
  return {
    th: {
      color: (0, import_theme_tools19.mode)("gray.600", "gray.400")(props),
      borderBottom: "1px",
      borderColor: (0, import_theme_tools19.mode)(`${c}.100`, `${c}.700`)(props),
      ...numericStyles
    },
    td: {
      borderBottom: "1px",
    ...
    caption: {
      color: (0, import_theme_tools19.mode)("gray.600", "gray.100")(props)
    },
    tfoot: {
      tr: {
        "&:last-of-type": {
    ...
    tbody: {
      tr: {
        "&:nth-of-type(odd)": {
          ...
          td: {
            background: (0, import_theme_tools19.mode)(`${c}.100`, `${c}.700`)(props)
          }
        }
      }
    },
...
var variantLine = definePartsStyle23((props) => {
  ...
  return {
    ...
    tab: {
      ...
      [marginProp]: "-2px",
      _selected: {
        color: (0, import_theme_tools20.mode)(`${c}.600`, `${c}.300`)(props),
        borderColor: "currentColor"
      },
      _active: {
        bg: (0, import_theme_tools20.mode)("gray.200", "whiteAlpha.300")(props)
      },
      _disabled: {
        _active: { bg: "none" }
      }
  ...
  return {
    tab: {
      ...
      _selected: {
        color: (0, import_theme_tools20.mode)(`${c}.600`, `${c}.300`)(props),
        borderColor: "inherit",
        borderBottomColor: (0, import_theme_tools20.mode)(`white`, `gray.800`)(props)
      }
    },
    tablist: {
      mb: "-1px",
...
var variantEnclosedColored = definePartsStyle23((props) => {
  ...
  return {
    tab: {
      border: "1px solid",
      borderColor: "inherit",
      bg: (0, import_theme_tools20.mode)(`gray.50`, `whiteAlpha.50`)(props),
      mb: "-1px",
      _notLast: {
        marginEnd: "-1px"
      },
      _selected: {
        bg: (0, import_theme_tools20.mode)("#fff", "gray.800")(props),
        color: (0, import_theme_tools20.mode)(`${c}.600`, `${c}.300`)(props),
        borderColor: "inherit",
...
var variantSoftRounded = definePartsStyle23((props) => {
  ...
  return {
    tab: {
      ...
      color: "gray.600",
      _selected: {
        color: (0, import_theme_tools20.getColor)(theme2, `${c}.700`),
        bg: (0, import_theme_tools20.getColor)(theme2, `${c}.100`)
      }
    }
  };
});
var variantSolidRounded = definePartsStyle23((props) => {
  ...
  return {
    tab: {
      borderRadius: "full",
      fontWeight: "semibold",
      color: (0, import_theme_tools20.mode)("gray.600", "inherit")(props),
      _selected: {
        color: (0, import_theme_tools20.mode)(`#fff`, "gray.800")(props),
        bg: (0, import_theme_tools20.mode)(`${c}.600`, `${c}.300`)(props)
      }
    }
  };
});
...
var $bg9 = (0, import_theme_tools21.cssVar)("tooltip-bg");
var $fg5 = (0, import_theme_tools21.cssVar)("tooltip-fg");
var $arrowBg2 = (0, import_theme_tools21.cssVar)("popper-arrow-bg");
