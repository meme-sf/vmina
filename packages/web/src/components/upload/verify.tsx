...
import { Badge, Box, Button, Center, Text, Modal, ModalOverlay, ModalContent, ModalBody, Icon, Image } from '@chakra-ui/react';
  ...
  return (
    <>
      <Box ref={finalRef}>
            ...
            <ModalBody paddingInline='0'>
              <Box mt='20px'>
                <Text color='black' textAlign='center' fontWeight='bold' fontSize='25px'>
                  Verifing your Proof on Mina...<br />
        ...
        <Center mt='50px'>
          <Button fontSize='2xl' p='30px' colorScheme='orange' onClick={handleSubmit}>
            <Image mr='10px' h='40px' src='minaIcon2.png' alt='mina' borderRadius='5px' />
