import { Field, Mina, fetchAccount } from 'snarkyjs';
// ========================================================
export const loopUntilAccountExists = async ({ account, eachTimeNotExist, isZkAppAccount, }) => {
    for (;;) {
...
export const makeAndSendTransaction = async ({ feePayerPrivateKey, zkAppPublicKey, mutateZkApp, transactionFee, getState, statesEqual, }) => {
...
// ========================================================
export const zkAppNeedsInitialization = async ({ zkAppAccount, }) => {
